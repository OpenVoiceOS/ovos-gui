...
class GUIMessageType(str, Enum):
    ...
    Data: {session_id, site_id, adapter_type}
    """
    ...
    GUI_PAGE_DELETE = "gui.page.delete"
    """Delete a specific page from namespace.

    Sent by: Skills
    Data: {__from: skill_id, page: page_number}
    """

    GUI_PAGE_DELETE_ALL = "gui.page.delete.all"
    """Clear all pages from namespace.
